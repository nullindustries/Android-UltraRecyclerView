package com.barista_v.ultrarecyclerview;
...
import com.barista_v.ultrarecyclerview.Decorators.DividerItemDecoration;
import com.barista_v.ultrarecyclerview.swipe.SwipeDismissRecyclerViewTouchListener;
...
public class UltraRecyclerView extends FrameLayout {
  ...
  protected void initAttrs(AttributeSet attrs) {
    ...
    try {
      mSuperRecyclerViewMainLayout = a.getResourceId(R.styleable.superrecyclerview_mainLayoutId,
      ...
      mPaddingBottom =
          (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingBottom, 0.0f);
      mPaddingLeft = (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingLeft, 0.0f);
      mPaddingRight =
          (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingRight, 0.0f);
      ...
      mProgressId =
          a.getResourceId(R.styleable.superrecyclerview_layout_progress, R.layout.layout_progress);
    } finally {
      a.recycle();
    }
  }
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
          ...
          if (((totalItemCount - lastVisibleItemPosition) <= loadMoreItemsCount ||
            ...
            if (mOnMoreListener != null) {
              ...
              mOnMoreListener.onMoreAsked(mRecyclerView.getAdapter().getItemCount(),
                  loadMoreItemsCount, lastVisibleItemPosition);
            }
          }
