...
import com.barista_v.ultrarecyclerview.swipe.BaseSwipeAdapter;
import com.barista_v.ultrarecyclerview.swipe.SwipeLayout;
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    viewHolder.deleteButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Toast.makeText(v.getContext(), "Deleted " + viewHolder.getPosition(), Toast.LENGTH_SHORT)
            .show();
      }
    });
    return viewHolder;
