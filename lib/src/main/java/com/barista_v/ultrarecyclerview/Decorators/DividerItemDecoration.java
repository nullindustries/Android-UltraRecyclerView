package com.barista_v.ultrarecyclerview.Decorators;
 ...
 * @author https://gist.github.com/danielgomezrico/121b116add8fbc3af615
 */
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context) {
        TypedArray typedArray = context.obtainStyledAttributes(null, new int[]{android.R.attr.listDivider});
